...
#include "com_blogspot_lashchenko_azbar_barcode_AZBar.h"

JNIEXPORT jstring JNICALL Java_com_blogspot_lashchenko_azbar_barcode_AZbar_process
...
//	__android_log_print(ANDROID_LOG_VERBOSE, "zbar params ___ ", "W: %d  H: %d", w, h);
